    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 uv = i.uv * _Size * aspect; //1 multiply by larger numver variable, declared at the top, 5 multiply by aspect
                ...
                float w = i.uv.y * 10; // 18 add variable 
                float x = (n - .5)* .8;  // -.4 4
